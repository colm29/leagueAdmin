...
class Season(db.Model):
    ...
    created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    user1 = db.relationship(AppUser, foreign_keys=created_by, lazy=True)
    updated_on = db.Column(db.DateTime)
    updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
    user2 = db.relationship(AppUser, foreign_keys=updated_by, lazy=True)
...
class Section(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='section.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class Comp(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='comp.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class Surface(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='surface.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class Home(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='home.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class Team(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='team.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class CompReg(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='comp_reg.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class Referee(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='referee.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
    # user2 = db.relationship(AppUser, foreign_keys='referee.updated_by')
...
class NewsItem(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='news_item.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
...
class FixtureRound(db.Model):
    ...
    # created_on = db.Column(db.DateTime(timezone=True), server_default=db.func.now(), nullable=False)
    # created_by = db.Column(db.Integer, db.ForeignKey('app_user.id'), nullable=False)
    # user1 = db.relationship(AppUser, foreign_keys='fixture_round.created_by')
    # updated_on = db.Column(db.DateTime)
    # updated_by = db.Column(db.Integer, db.ForeignKey('app_user.id'))
